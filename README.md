<div align="center">    
    ...
    <a href="https://github.com/triabagus/react-store-phone-recording/fork">
...
make new file .env
```bash
REACT_APP_APP_ID=YOUR-CLIENT-ID-PAYPAL
```
...
- [Illustrasion: unDraw](https://undraw.co/search)
- [Package: Paypal Express React Checkout](https://www.npmjs.com/package/react-paypal-express-checkout)
- [Developer Paypal API](https://developer.paypal.com/home/)
